...
- [x] **M5.16 AR Walk experiment** — square/hex tiled maps expose an optional listener mode that watches mobile WebXR viewer pose, smooths real-world movement deltas, maps the first clear walking direction to the composition's current facing, and turns the listener toward travel direction while existing map wrapping/clamping/audio updates keep working.
